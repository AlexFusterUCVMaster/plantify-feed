...
const mockPosts = {
  "1": {
    ...
    description: "Mi monstera está creciendo increíblemente bien este verano. Las hojas nuevas son enormes y tienen unas fenestras perfectas. Le he dado mucho amor y luz indirecta.",
  ...
  "2": {
    ...
    description: "Este pothos ha crecido más de 2 metros en solo 6 meses. Es increíble lo rápido que crece con el cuidado adecuado.",
    userName: "GreenThumb",
    userInitials: "GT",
    likes: 189,
    comments: [
  ...
  "3": {
    ...
    description: "Mi ficus finalmente se está adaptando a su nueva ubicación. Las hojas nuevas son un buen indicador de que está feliz.",
  ...
  "4": {
    ...
    description: "Esta echeveria está comenzando a florecer. Las flores naranjas son preciosas y contrastan perfectamente con las hojas azuladas.",
  ...
  "5": {
    ...
    description: "Las calatheas son mis favoritas por sus patrones de hojas únicos. Esta es mi última adquisición y estoy enamorada.",
